<?php 
 $GLOBALS["dictionary"]["User"]=array (
  ...
  array (
    ...
    'opportunities_users_2opportunities_ida' => 
    array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Management Committee',
      'required' => true,
      'source' => 'custom_fields',
      'name' => 'mc_c',
      'vname' => 'LBL_MC',
    ...
    array (
      ...
      'merge_filter' => 'disabled',
      'size' => '20',
      'options' => 'teamfunction_c_list',
      'studio' => 'visible',
      'isMultiSelect' => true,
      'id' => 'Usersteamfunction_c',
      'custom_module' => 'Users',
    ),
    'teamheirarchy_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Team Heirarchy',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'teamheirarchy_c',
      'vname' => 'LBL_TEAMHEIRARCHY',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'teamheirarchy_c_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Usersteamheirarchy_c',
      'custom_module' => 'Users',
    ),
  ),
  'indices' => 
