<?php /* Smarty version 2.6.31, created on 2021-03-05 14:47:50
         compiled from cache/themes/SuiteP/modules/Employees/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Employees/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/Employees/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Employees/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Employees/SearchForm_advanced.tpl', 94, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/Employees/SearchForm_advanced.tpl', 363, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Employees/SearchForm_advanced.tpl', 444, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='first_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_NAME','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='last_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_NAME','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='employee_status_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EMPLOYEE_STATUS','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'employee_status_advanced','name' => 'employee_status_advanced[]','options' => $this->_tpl_vars['fields']['employee_status_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['employee_status_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='title_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TITLE','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='phone_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_PHONE','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='department_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEPARTMENT','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='email_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_EMAIL','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_street_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_ADDRESS','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_city_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CITY','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_state_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATE','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_postalcode_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_POSTAL_CODE','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_country_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_COUNTRY','module' => 'Employees'), $this);?>
</label>
                            </div>
            <div class="form-item">
