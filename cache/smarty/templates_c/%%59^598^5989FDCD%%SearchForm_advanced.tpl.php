<?php /* Smarty version 2.6.31, created on 2021-03-05 14:12:04
         compiled from cache/themes/SuiteP/modules/Opportunities/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Opportunities/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/Opportunities/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Opportunities/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Opportunities/SearchForm_advanced.tpl', 66, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/Opportunities/SearchForm_advanced.tpl', 128, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Opportunities/SearchForm_advanced.tpl', 209, false),)), $this); ?>
...
<?php echo smarty_function_html_options(array('id' => 'assigned_user_id_advanced','name' => 'assigned_user_id_advanced[]','options' => $this->_tpl_vars['fields']['assigned_user_id_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['assigned_user_id_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='select_approver_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_APPROVER','module' => 'Opportunities'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="<?php echo $this->_tpl_vars['fields']['select_approver_c_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['select_approver_c_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['select_approver_c_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['user_id2_c_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['user_id2_c_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['select_approver_c_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['select_approver_c_advanced']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"user_id2_c_advanced","name":"select_approver_c_advanced"}}'; ?>
, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['select_approver_c_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['select_approver_c_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['user_id2_c_advanced']['name']; ?>
...
"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'Opportunities'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'status_c_advanced','name' => 'status_c_advanced[]','options' => $this->_tpl_vars['fields']['status_c_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['status_c_advanced']['value']), $this);?>
