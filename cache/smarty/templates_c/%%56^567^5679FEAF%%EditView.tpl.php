<?php /* Smarty version 2.6.31, created on 2021-03-11 12:09:45
...
<script type="text/javascript" src='include/SugarFields/Fields/Image/SugarFieldFile.js?v=JldXxee5EKWNEJ97FnUWeg'></script>
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_MC">
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="mc_c"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>

<?php if ($this->_tpl_vars['IS_ADMIN']): ?>
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['mc_c']['value'] ) && $this->_tpl_vars['fields']['mc_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['mc_c']['options'],'selected' => $this->_tpl_vars['fields']['mc_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['mc_c']['options'],'selected' => $this->_tpl_vars['fields']['mc_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['mc_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['mc_c']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<?php echo '
<script>
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['mc_c']['name']; ?>
');
...
<?php endif; ?><?php else: ?><?php echo $this->_tpl_vars['fields']['mc_c']['value']; ?>
<?php endif; ?>
</div>
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_TEAMHEIRARCHY">
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="teamheirarchy_c"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>

<?php if ($this->_tpl_vars['IS_ADMIN']): ?>
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['teamheirarchy_c']['value'] ) && $this->_tpl_vars['fields']['teamheirarchy_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['teamheirarchy_c']['options'],'selected' => $this->_tpl_vars['fields']['teamheirarchy_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['teamheirarchy_c']['options'],'selected' => $this->_tpl_vars['fields']['teamheirarchy_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['teamheirarchy_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<?php echo '
<script>
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['name']; ?>
');
...
<?php endif; ?><?php else: ?><?php echo $this->_tpl_vars['fields']['teamheirarchy_c']['value']; ?>
<?php endif; ?>
</div>
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"reports_to_id","full_name":"reports_to_name"}}'; ?>
, 
"single", 
true
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_BID_COMMERCIAL_HEAD">
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="bid_commercial_head_c"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['bid_commercial_head_c']['value'] ) && $this->_tpl_vars['fields']['bid_commercial_head_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['bid_commercial_head_c']['options'],'selected' => $this->_tpl_vars['fields']['bid_commercial_head_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['bid_commercial_head_c']['options'],'selected' => $this->_tpl_vars['fields']['bid_commercial_head_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['bid_commercial_head_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<?php echo '
<script>
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['bid_commercial_head_c']['name']; ?>
');
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_TEAMFUNCTION">
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="multienum" field="teamfunction_c"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>

<?php if ($this->_tpl_vars['IS_ADMIN']): ?>
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<input type="hidden" id="<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
_multiselect"
name="<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
_multiselect" value="true">
<?php echo smarty_function_multienum_to_array(array('string' => $this->_tpl_vars['fields']['teamfunction_c']['value'],'default' => $this->_tpl_vars['fields']['teamfunction_c']['default'],'assign' => 'values'), $this);?>

<select id="<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
"
name="<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['teamfunction_c']['options'],'selected' => $this->_tpl_vars['values']), $this);?>

</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['teamfunction_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['teamfunction_c']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<input type="hidden" id="<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
_multiselect"
...
<select style='display:none' id="<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
"
name="<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
...
<input
id="<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
-input"
size="60"
...
<button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
;');SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
...
<?php echo '.ds = new Y.DataSource.Function({
					    source: function (request) {
					    	var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
<?php echo '");
					    	var ret = [];
					    	for (i=0;i<selectElem.options.length;i++)
					    		if (!(selectElem.options[i].value==\'\' && selectElem.options[i].innerHTML==\'\'))
	...
	YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters","node-event-simulate", function (Y) {
	    ...
	    SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
-input');
	    SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
-image');
	    SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['teamfunction_c']['name']; ?>
');
...
<?php endif; ?>
<?php else: ?><?php echo $this->_tpl_vars['fields']['teamfunction_c']['value']; ?>
<?php endif; ?>
</div>
...
<?php echo '\' );
addToValidate(\'EditView\', \'first_name\', \'name\', true,\''; ?>
...
<?php echo '\' );
addToValidate(\'EditView\', \'opportunities_users_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_OPPORTUNITIES_USERS_1_FROM_OPPORTUNITIES_TITLE','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'opportunities_users_2_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_OPPORTUNITIES_USERS_2_FROM_OPPORTUNITIES_TITLE','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'bid_commercial_head_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_BID_COMMERCIAL_HEAD','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TEAMHEIRARCHY','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
