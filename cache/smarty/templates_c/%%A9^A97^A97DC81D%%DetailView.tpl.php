<?php /* Smarty version 2.6.31, created on 2021-03-16 18:02:13
...
<?php if (! $this->_tpl_vars['fields']['document_visibility_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['document_visibility_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['document_visibility_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['document_visibility_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['document_visibility_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['document_visibility_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['document_visibility_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['document_visibility_c']['options'][$this->_tpl_vars['fields']['document_visibility_c']['value']]; ?>
...
"><?php echo $this->_tpl_vars['fields']['status_c']['value']; ?>
</span>
<?php endif; ?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['category_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['category_c']['value']; ?>
</span>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['sub_category_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['sub_category_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['sub_category_c']['value']; ?>
</span>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['follow_up_date_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php else: ?>
<?php if (strlen ( $this->_tpl_vars['fields']['follow_up_date_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['follow_up_date_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['follow_up_date_c']['value']); ?>
<?php endif; ?>
<?php endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['follow_up_date_c']['name']; ?>
...
<?php if (! $this->_tpl_vars['fields']['tagged_hidden_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['tagged_hidden_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['tagged_hidden_c']['value']; ?>
</span>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['tag_comments_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<span class="sugar_field" id="<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['tag_comments_c']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['tag_comments_c']['value'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html_entity_decode') : smarty_modifier_escape($_tmp, 'html_entity_decode')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</span>
<?php endif; ?>
