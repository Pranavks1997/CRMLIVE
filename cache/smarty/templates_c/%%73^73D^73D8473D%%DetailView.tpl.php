<?php /* Smarty version 2.6.31, created on 2021-04-01 14:53:23
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="varchar" field="name" >
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="datetimecombo" field="date_time_start" >

<?php if (! $this->_tpl_vars['fields']['date_time_start']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['date_time_start']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['date_time_start']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['date_time_start']['value']); ?>
<?php endif; ?> 
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="time" field="time_from" >

<?php if (! $this->_tpl_vars['fields']['time_from']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="datetimecombo" field="date_time_end" >

<?php if (! $this->_tpl_vars['fields']['date_time_end']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['date_time_end']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['date_time_end']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['date_time_end']['value']); ?>
<?php endif; ?> 
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="time" field="time_to" >

<?php if (! $this->_tpl_vars['fields']['time_to']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_RUN','module' => 'Schedulers'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="datetime" field="last_run" >
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="varchar" field="job_interval" >

<?php if (! $this->_tpl_vars['fields']['job_interval']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="bool" field="catch_up" >

<?php if (! $this->_tpl_vars['fields']['catch_up']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="varchar" field="job" >

<?php if (! $this->_tpl_vars['fields']['job']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['job']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['job']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['job']['value']); ?>
<?php endif; ?> 
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'Schedulers'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'Schedulers'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
