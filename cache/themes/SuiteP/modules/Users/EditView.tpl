...
{if $IS_ADMIN}
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.mc_c.name}" 
id="{$fields.mc_c.name}" 
title=''       
>
{if isset($fields.mc_c.value) && $fields.mc_c.value != ''}
{html_options options=$fields.mc_c.options selected=$fields.mc_c.value}
{else}
{html_options options=$fields.mc_c.options selected=$fields.mc_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.mc_c.options }
{capture name="field_val"}{$fields.mc_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.mc_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.mc_c.name}" 
id="{$fields.mc_c.name}" 
title=''          
>
{if isset($fields.mc_c.value) && $fields.mc_c.value != ''}
...
<input
id="{$fields.mc_c.name}-input"
name="{$fields.mc_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.mc_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.mc_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.mc_c.name}-input', '{$fields.mc_c.name}');sync_{$fields.mc_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.mc_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.mc_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.mc_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.mc_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.mc_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.mc_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.mc_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{if $IS_ADMIN}
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.teamheirarchy_c.name}" 
id="{$fields.teamheirarchy_c.name}" 
title=''       
>
{if isset($fields.teamheirarchy_c.value) && $fields.teamheirarchy_c.value != ''}
{html_options options=$fields.teamheirarchy_c.options selected=$fields.teamheirarchy_c.value}
{else}
{html_options options=$fields.teamheirarchy_c.options selected=$fields.teamheirarchy_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.teamheirarchy_c.options }
{capture name="field_val"}{$fields.teamheirarchy_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.teamheirarchy_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.teamheirarchy_c.name}" 
id="{$fields.teamheirarchy_c.name}" 
title=''          
>
{if isset($fields.teamheirarchy_c.value) && $fields.teamheirarchy_c.value != ''}
...
<input
id="{$fields.teamheirarchy_c.name}-input"
name="{$fields.teamheirarchy_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.teamheirarchy_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.teamheirarchy_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.teamheirarchy_c.name}-input', '{$fields.teamheirarchy_c.name}');sync_{$fields.teamheirarchy_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.teamheirarchy_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.teamheirarchy_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.teamheirarchy_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.teamheirarchy_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.teamheirarchy_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.teamheirarchy_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.teamheirarchy_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{/literal}
{/if}{else}{$fields.teamheirarchy_c.value}{/if}
</div>
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"reports_to_id","full_name":"reports_to_name"}}{/literal}, 
"single", 
true
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.bid_commercial_head_c.name}" 
id="{$fields.bid_commercial_head_c.name}" 
title=''       
>
{if isset($fields.bid_commercial_head_c.value) && $fields.bid_commercial_head_c.value != ''}
{html_options options=$fields.bid_commercial_head_c.options selected=$fields.bid_commercial_head_c.value}
{else}
{html_options options=$fields.bid_commercial_head_c.options selected=$fields.bid_commercial_head_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.bid_commercial_head_c.options }
{capture name="field_val"}{$fields.bid_commercial_head_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.bid_commercial_head_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.bid_commercial_head_c.name}" 
id="{$fields.bid_commercial_head_c.name}" 
title=''          
>
{if isset($fields.bid_commercial_head_c.value) && $fields.bid_commercial_head_c.value != ''}
...
<input
id="{$fields.bid_commercial_head_c.name}-input"
name="{$fields.bid_commercial_head_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.bid_commercial_head_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.bid_commercial_head_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.bid_commercial_head_c.name}-input', '{$fields.bid_commercial_head_c.name}');sync_{$fields.bid_commercial_head_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.bid_commercial_head_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.bid_commercial_head_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.bid_commercial_head_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.bid_commercial_head_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.bid_commercial_head_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.bid_commercial_head_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.bid_commercial_head_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{/literal}
{/if}
{else}{$fields.teamfunction_c.value}{/if}
</div>
...
addToValidate('EditView', 'first_name', 'name', true,'{/literal}{sugar_translate label='LBL_FIRST_NAME' module='Users' for_js=true}{literal}' );
...
addToValidate('EditView', 'opportunities_users_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES_USERS_1_FROM_OPPORTUNITIES_TITLE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'opportunities_users_2_name', 'relate', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES_USERS_2_FROM_OPPORTUNITIES_TITLE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'bid_commercial_head_c', 'enum', false,'{/literal}{sugar_translate label='LBL_BID_COMMERCIAL_HEAD' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'mc_c', 'enum', true,'{/literal}{sugar_translate label='LBL_MC' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'teamfunction_c[]', 'multienum', true,'{/literal}{sugar_translate label='LBL_TEAMFUNCTION' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'teamheirarchy_c', 'enum', false,'{/literal}{sugar_translate label='LBL_TEAMHEIRARCHY' module='Users' for_js=true}{literal}' );
