...
{if is_string($fields.activity_type_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.activity_type_c.name}" value="{ $fields.activity_type_c.options }">
{ $fields.activity_type_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.activity_type_c.name}" value="{ $fields.activity_type_c.value }">
{ $fields.activity_type_c.options[$fields.activity_type_c.value]}
{/if}
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.status_new_c.name}">{$fields.status_new_c.value}</span>
{/if}
...
{if !$fields.assigned_to_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.assigned_to_c.name}">{$fields.assigned_to_c.value}</span>
{/if}
...
{if !$fields.audit_trail_c.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.audit_trail_c.name|escape:'html'|url2html|nl2br}">{$fields.audit_trail_c.value|escape:'html'|escape:'html_entity_decode'|url2html|nl2br}</span>
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.untag_c.name}">{$fields.untag_c.value}</span>
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.tag_c.name}">{$fields.tag_c.value}</span>
{/if}
...
{if !$fields.tagged_comments_c.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.tagged_comments_c.name|escape:'html'|url2html|nl2br}">{$fields.tagged_comments_c.value|escape:'html'|escape:'html_entity_decode'|url2html|nl2br}</span>
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.tag_hidden_c.name}">{$fields.tag_hidden_c.value}</span>
{/if}
...
{if !$fields.untag_hidden_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.untag_hidden_c.name}">{$fields.untag_hidden_c.value}</span>
{/if}
