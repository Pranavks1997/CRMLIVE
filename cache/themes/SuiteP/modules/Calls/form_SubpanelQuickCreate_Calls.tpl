...
addToValidate('form_SubpanelQuickCreate_Calls', 'new_current_status_c', 'text', false,'{/literal}{sugar_translate label='LBL_NEW_CURRENT_STATUS' module='Calls' for_js=true}{literal}' );
