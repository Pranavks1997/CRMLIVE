...
<select name="{$fields.document_visibility_c.name}" 
id="{$fields.document_visibility_c.name}" 
title=''       
>
{if isset($fields.document_visibility_c.value) && $fields.document_visibility_c.value != ''}
{html_options options=$fields.document_visibility_c.options selected=$fields.document_visibility_c.value}
{else}
{html_options options=$fields.document_visibility_c.options selected=$fields.document_visibility_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.document_visibility_c.options }
{capture name="field_val"}{$fields.document_visibility_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.document_visibility_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.document_visibility_c.name}" 
id="{$fields.document_visibility_c.name}" 
title=''          
>
{if isset($fields.document_visibility_c.value) && $fields.document_visibility_c.value != ''}
...
<input
id="{$fields.document_visibility_c.name}-input"
name="{$fields.document_visibility_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.document_visibility_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.document_visibility_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.document_visibility_c.name}-input', '{$fields.document_visibility_c.name}');sync_{$fields.document_visibility_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	...
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.document_visibility_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.document_visibility_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.document_visibility_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.document_visibility_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.document_visibility_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.document_visibility_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.document_visibility_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{/if}  
<input type='text' name='{$fields.status_c.name}' 
id='{$fields.status_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
<script type="text/javascript" src='cache/include/externalAPI.cache.js?v=6c2PgQ6fe5VejqGzm1UlCQ'></script>
<script type="text/javascript" src='include/SugarFields/Fields/File/SugarFieldFile.js?v=6c2PgQ6fe5VejqGzm1UlCQ'></script>
...
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.template_type.name}-input', '{$fields.template_type.name}');sync_{$fields.template_type.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_Documents","field_to_name_array":{"id":"user_id_c","name":"approver_c"}}{/literal}, 
"single", 
true
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_Documents","field_to_name_array":{"id":"assigned_user_id","user_name":"assigned_user_name"}}{/literal}, 
"single", 
true
...
{/if}  
<input type='text' name='{$fields.category_c.name}' 
id='{$fields.category_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/if}  
<input type='text' name='{$fields.sub_category_c.name}' 
id='{$fields.sub_category_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
<span class="dateTime">
{assign var=date_value value=$fields.follow_up_date_c.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.follow_up_date_c.name}" id="{$fields.follow_up_date_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
<button type="button" id="{$fields.follow_up_date_c.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.follow_up_date_c.name}",
form : "form_SubpanelQuickCreate_Documents",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.follow_up_date_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
addToValidate('form_SubpanelQuickCreate_Documents', 'documents', 'file', false,'{/literal}{sugar_translate label='LBL_DOCUMENTS' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'tagged_users_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TAGGED_USERS' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'tagged_hidden_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TAGGED_HIDDEN' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'approver_c', 'relate', false,'{/literal}{sugar_translate label='LBL_APPROVER' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'parent_name', 'parent', false,'{/literal}{sugar_translate label='RELATED TO' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'follow_up_date_c', 'date', false,'{/literal}{sugar_translate label='LBL_FOLLOW_UP_DATE' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'category_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CATEGORY' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'user_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_APPROVER_USER_ID' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'parent_type', 'parent_type', false,'{/literal}{sugar_translate label='LBL_PARENT_TYPE' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'parent_id', 'id', false,'{/literal}{sugar_translate label='LBL_PARENT_ID' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'document_visibility_c', 'enum', false,'{/literal}{sugar_translate label='LBL_DOCUMENT_VISIBILITY' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'tag_comments_c', 'text', false,'{/literal}{sugar_translate label='LBL_TAG_COMMENTS' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'sub_category_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SUB_CATEGORY' module='Documents' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Documents', 'status_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_STATUS' module='Documents' for_js=true}{literal}' );
...
addToValidateBinaryDependency('form_SubpanelQuickCreate_Documents', 'approver_c', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Documents' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_APPROVER' module='Documents' for_js=true}{literal}', 'user_id_c' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['form_SubpanelQuickCreate_Documents_approver_c']={"form":"form_SubpanelQuickCreate_Documents","method":"query","modules":["Users"],"group":"or","field_list":["name","id"],"populate_list":["approver_c","user_id_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects['form_SubpanelQuickCreate_Documents_parent_name']={"form":"form_SubpanelQuickCreate_Documents","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["parent_name","parent_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects['form_SubpanelQuickCreate_Documents_assigned_user_name']={"form":"form_SubpanelQuickCreate_Documents","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>{/literal}
