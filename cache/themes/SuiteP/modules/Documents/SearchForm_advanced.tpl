...
{html_options id='template_type_advanced' name='template_type_advanced[]' options=$fields.template_type_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.template_type_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='parent_name_advanced'>{sugar_translate label='RELATED TO' module='Documents'}</label>
                            </div>
            <div class="form-item">
...
{/literal}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='category_c_advanced'>{sugar_translate label='LBL_CATEGORY' module='Documents'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.category_c_advanced.value) <= 0}
{assign var="value" value=$fields.category_c_advanced.default_value }
{else}
{assign var="value" value=$fields.category_c_advanced.value }
{/if}  
<input type='text' name='{$fields.category_c_advanced.name}' 
    id='{$fields.category_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
                            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='sub_category_c_advanced'>{sugar_translate label='LBL_SUB_CATEGORY' module='Documents'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.sub_category_c_advanced.value) <= 0}
{assign var="value" value=$fields.sub_category_c_advanced.default_value }
{else}
{assign var="value" value=$fields.sub_category_c_advanced.value }
{/if}  
<input type='text' name='{$fields.sub_category_c_advanced.name}' 
    id='{$fields.sub_category_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
                            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_c_advanced'>{sugar_translate label='LBL_STATUS' module='Documents'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.status_c_advanced.value) <= 0}
{assign var="value" value=$fields.status_c_advanced.default_value }
{else}
{assign var="value" value=$fields.status_c_advanced.value }
{/if}  
<input type='text' name='{$fields.status_c_advanced.name}' 
    id='{$fields.status_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
                            </div>
        </div>
