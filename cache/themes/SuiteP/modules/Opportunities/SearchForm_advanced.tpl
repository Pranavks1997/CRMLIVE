...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.assigned_user_id_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='select_approver_c_advanced'>{sugar_translate label='LBL_SELECT_APPROVER' module='Opportunities'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.select_approver_c_advanced.name}"  class="sqsEnabled"   id="{$fields.select_approver_c_advanced.name}" size="" value="{$fields.select_approver_c_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.user_id2_c_advanced.name}" value="{$fields.user_id2_c_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.select_approver_c_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.select_approver_c_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"user_id2_c_advanced","name":"select_approver_c_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.select_approver_c_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.select_approver_c_advanced.name}.value = ''; this.form.{$fields.user_id2_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_c_advanced'>{sugar_translate label='LBL_STATUS' module='Opportunities'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='status_c_advanced' name='status_c_advanced[]' options=$fields.status_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.status_c_advanced.value}
                            </div>
        </div>
    </div>
