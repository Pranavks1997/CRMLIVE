...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='first_name_advanced'>{sugar_translate label='LBL_FIRST_NAME' module='Employees'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.first_name_advanced.name}' 
    ...
    value='{$value}' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='last_name_advanced'>{sugar_translate label='LBL_LAST_NAME' module='Employees'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.last_name_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='employee_status_advanced'>{sugar_translate label='LBL_EMPLOYEE_STATUS' module='Employees'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='employee_status_advanced' name='employee_status_advanced[]' options=$fields.employee_status_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.employee_status_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='title_advanced'>{sugar_translate label='LBL_TITLE' module='Employees'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.title_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='phone_advanced'>{sugar_translate label='LBL_ANY_PHONE' module='Employees'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.phone_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='department_advanced'>{sugar_translate label='LBL_DEPARTMENT' module='Employees'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.department_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='email_advanced'>{sugar_translate label='LBL_ANY_EMAIL' module='Employees'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.email_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_street_advanced'>{sugar_translate label='LBL_ANY_ADDRESS' module='Employees'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.address_street_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_city_advanced'>{sugar_translate label='LBL_CITY' module='Employees'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.address_city_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_state_advanced'>{sugar_translate label='LBL_STATE' module='Employees'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.address_state_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_postalcode_advanced'>{sugar_translate label='LBL_POSTAL_CODE' module='Employees'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.address_postalcode_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='address_country_advanced'>{sugar_translate label='LBL_COUNTRY' module='Employees'}</label>
                            </div>
            <div class="form-item">
