...
addToValidate('EditView', 'country_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_COUNTRY' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'city_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CITY' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'state_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_STATE' module='Accounts' for_js=true}{literal}' );
