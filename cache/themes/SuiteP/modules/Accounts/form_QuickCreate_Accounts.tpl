...
addToValidate('form_QuickCreate_Accounts', 'country_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_COUNTRY' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'city_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CITY' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'state_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_STATE' module='Accounts' for_js=true}{literal}' );
