...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	{/if}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='country_c_advanced'>{sugar_translate label='LBL_COUNTRY' module='Accounts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.country_c_advanced.value) <= 0}
{assign var="value" value=$fields.country_c_advanced.default_value }
{else}
{assign var="value" value=$fields.country_c_advanced.value }
{/if}  
<input type='text' name='{$fields.country_c_advanced.name}' 
    id='{$fields.country_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
                            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='state_c_advanced'>{sugar_translate label='LBL_STATE' module='Accounts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.state_c_advanced.value) <= 0}
{assign var="value" value=$fields.state_c_advanced.default_value }
{else}
{assign var="value" value=$fields.state_c_advanced.value }
{/if}  
<input type='text' name='{$fields.state_c_advanced.name}' 
    id='{$fields.state_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
                            </div>
        </div>
