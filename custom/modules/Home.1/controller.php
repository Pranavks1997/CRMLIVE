...
public function action_pending_records()
{
    ...
    $data = '<table class="pending-request-table" style="font-family: Lato, Lato, Arial, sans-serif !important;
        ...
        <i id="setting_myBtn" class="fa fa-cog" aria-hidden="true"> </i>
        </button>
        </div>
        </div>
        </div>
    ...
    public function action_filter_opportunities_by_status(){
        try
        {
            ...
            $db = \DBManagerFactory::getInstance();
            $GLOBALS['db'];
            $organiztion_global_count = "SELECT count(*) as org_global_count FROM opportunities WHERE opportunity_type = 'global' AND deleted != 1";
            ...
            $non_global_organization_count = $this->get_non_global_op_count();
                    ...
                    <div class="search-box">
                        ...
                        <div style="display: flex;">
                            <div style="display: flex; justify-content: center; align-items: center;">
                                <input type="text" placeholder="Search by name" class="opportunity-search" id="opportunity-search" data-type="filter_opportunities_by_status" data-value="'.$status_c.'" value="'.$searchTerm.'" name="search" />
...
if($columnDateClosed){
        ...
        $data .= '<th class="table-header">Action</th></tr>';
           ...
           if($searchTerm){
            $fetch_by_status = "SELECT * FROM opportunities LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c WHERE status_c='$status_c' AND deleted != 1 AND name LIKE '%$searchTerm%' ";
           }else{
            $fetch_by_status = "SELECT * FROM opportunities LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c WHERE status_c='$status_c' AND deleted != 1 ";
           }
            ...
            if($status_c == 'Closed'){
                ...
                (status_c='Dropped' OR (status_c='Closed' AND opportunities_cstm.closure_status_c = 'lost')) AND deleted != 1 ";
            }
            ...
            if($_GET['filter'] && @$_GET['filter-closed-date-from'] && @$_GET['filter-closed-date-to']){
                ...
                $fetch_by_status .= " AND DATE_FORMAT(opportunities.date_closed, '%d/%m/%Y') BETWEEN '$closedDateFrom' AND '$closedDateTo' ";
            }
            ...
            align-items: center;height: 50px">
                ...
                <li class="search-box-block">
                    <div class="search-box">
                        ...
                        <div style="display: flex;">
                            <div style="display: flex; justify-content: center; align-items: center;">
                                <input type="text" placeholder="Search by name" class="opportunity-search" id="opportunity-search" data-type="filter_by_opportunity_type" data-value="'.$type.'" value="'.$searchTerm.'" name="search" />
                                <button class="searchhh opportunity-search-btn" id="search-btn">
                                    <i id="search-icon" class="fa fa-search" aria-hidden="true"> </i>
                                </button>
                            </div>
...
if($columnDateClosed){
            ...
            $type = $_GET['type'];
            if($searchTerm){
                $fetch_query = "SELECT * FROM opportunities LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c WHERE opportunity_type='$type' AND deleted != 1 AND name LIKE '%$searchTerm%' AND 
                opportunities.id NOT IN(
                SELECT opp_id FROM untagged_user WHERE user_id LIKE '%$log_in_user_id%'
                ) ";
            }else{
                $fetch_query = "SELECT * FROM opportunities LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c WHERE opportunity_type='$type' AND deleted != 1 AND 
                opportunities.id NOT IN(
                SELECT opp_id FROM untagged_user WHERE user_id LIKE '%$log_in_user_id%'
                )";
            }
            ...
            if($_GET['filter'] && @$_GET['filter-closed-date-from'] && @$_GET['filter-closed-date-to']){
                $closedDateFrom = $_GET['filter-closed-date-from'];
                $closedDateTo = $_GET['filter-closed-date-to'];
                $fetch_query .= " AND DATE_FORMAT(opportunities.date_closed, '%d/%m/%Y') BETWEEN '$closedDateFrom' AND '$closedDateTo' ";
            }
            if($_GET['filter'] && @$_GET['filter-created-date-from'] && @$_GET['filter-created-date-to']){
                $createdDateFrom = $_GET['filter-created-date-from'];
                $createdDateTo = $_GET['filter-created-date-to'];
...
$columnDateClosed = @$columnFilter['Date-Closed'];
            ...
            $fetch_total_opportunity = "SELECT count(*) as total from opportunities WHERE deleted != 1";
            $fetch_total_result = $GLOBALS['db']->query($fetch_total_opportunity);
            $fetch_total = $GLOBALS['db']->fetchByAssoc($fetch_total_result);
            $total = $fetch_total['total'];
           ...
           $fetch_self_count = "SELECT count(*) as self_count FROM opportunities LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c WHERE  created_by='$log_in_user_id' AND deleted != 1";
           $fetch_self_result = $GLOBALS['db']->query($fetch_self_count);
           $fetch_self = $GLOBALS['db']->fetchByAssoc($fetch_self_result);
           $self_count = $fetch_self['self_count'];
           

           $fetch_team_count = "SELECT count(*) as team_count from opportunities LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c WHERE  deleted != 1 AND assigned_user_id IN (SELECT id_c FROM users_cstm WHERE teamfunction_c = (SELECT teamfunction_c FROM users_cstm WHERE id_c = '$log_in_user_id'))";
            $fetch_team_result = $GLOBALS['db']->query($fetch_team_count);
            $fetch_team = $GLOBALS['db']->fetchByAssoc($fetch_team_result);
            $team_count = $fetch_team['team_count'];
           ...
           $result = array();
            ...
            $fetch_status_leads = "SELECT count(oc.id_c) as mainCount, oc.status_c FROM opportunities o LEFT JOIN opportunities_cstm oc ON o.id = oc.id_c WHERE o.deleted != 1 GROUP BY oc.status_c";
            ...
            {   
                ...
                $fetch_team_count_by_status = "SELECT count(*) as team_count_by_status from opportunities LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c WHERE  deleted != 1 AND status_c= '".$row['status_c']."' AND assigned_user_id IN (SELECT id_c FROM users_cstm WHERE teamfunction_c = (SELECT teamfunction_c FROM users_cstm WHERE id_c = '$log_in_user_id')) ";
                ...
                $fetch_self_count_by_status = "SELECT count(*) as self_count_by_status FROM opportunities LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c WHERE status_c= '".$row['status_c']."' AND created_by='$log_in_user_id' AND deleted != 1";
                ...
                if ($Status == 'Closed' || $Status == 'Dropped') {
                    $closed_lost_count_query = "SELECT count(*) as lost_count FROM opportunities o LEFT JOIN opportunities_cstm oc ON o.id = oc.id_c WHERE o.deleted != 1 AND oc.status_c='Closed' AND oc.closure_status_c ='lost'";
                    $closed_lost_count_result = $GLOBALS['db']->query($closed_lost_count_query);
                    $closed_lost_count = $GLOBALS['db']->fetchByAssoc($closed_lost_count_result);
                    if ($Status == 'Closed') {
                        $Status = 'Closed Win';
                        $main_count = $main_count - $closed_lost_count['lost_count'];
                        if ($team_count_by_status > $closed_lost_count['lost_count']) {
                            $team_count_by_status = $team_count_by_status - $closed_lost_count['lost_count'];
                        }
                        if ($self_count_by_status > $closed_lost_count['lost_count']) {
                            $self_count_by_status = $self_count_by_status - $closed_lost_count['lost_count'];
                        }
                    }else if ($Status == 'Dropped') {
                        $Status = 'Dropped * Closed Lost';
                        $main_count = $main_count + $closed_lost_count['lost_count'];
                        $team_count_by_status = $team_count_by_status + $closed_lost_count['lost_count'];
                        $self_count_by_status = $self_count_by_status + $closed_lost_count['lost_count'];
                    }
            ...
            $fetch_by_status .= $Lead_chunk .$QualifiedLead_chunk . $QualifiedOpportunity_chunk . $QualifiedDpr_chunk . $QualifiedBid_chunk . $Close_chunk . $Dropped_chunk;
            $data = '<table class="bottomtable" style="font-family: Lato, Lato, Arial, sans-serif !important;
            height: 400px;
            overflow-y: auto;
            overflow-x: hidden;
            ...
            align-items: center;height: 50px">
                ...
                <li class="search-box-block">
                    <div class="search-box">
                        ...
                        <div style="display: flex;">
                            <div style="display: flex; justify-content: center; align-items: center;">
                                <input type="text" placeholder="Search by name" class="opportunity-search" id="opportunity-search" data-type="show_data_between_date" data-value="'.$day.'" value="'.$searchTerm.'" name="search" />
                                <button class="searchhh opportunity-search-btn" id="search-btn">
                                    <i id="search-icon" class="fa fa-search" aria-hidden="true"> </i>
                                </button>
                            </div>
...
if($columnDateClosed){
            ...
            if($searchTerm){
                $fetch_query = "SELECT opportunities.*, opportunities_cstm.* FROM opportunities
                    LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c WHERE opportunities.deleted != 1 AND opportunities.name LIKE '%$searchTerm%' ";
            }else{
                $fetch_query = "SELECT opportunities.*, opportunities_cstm.* FROM opportunities
                    LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c WHERE deleted != 1 ";
            }
    ...
    public function get_default_chunk($status) {
        ...
        if ($status == 'Closed' || $status == 'Dropped') {
            ...
            if ($status == 'Closed') {
                ...
                $status = 'Dropped * Closed Lost';
                $default_count = $default_count + $closed_lost_count['lost_count'];
                $team_count_by_status = $team_count_by_status + $closed_lost_count['lost_count'];
                $self_count_by_status = $self_count_by_status + $closed_lost_count['lost_count'];
                $statusVal = 'Dropped';
            }
        }
        return '<div id=\''.$statusVal.'\' class="card-status" onclick="fetchRecordByStatus_C(\''.$statusVal.'\',\''.$day.'\')">
        <p class="card-status-head">'.$this->split_camel_case($status).'</p>
    ...
    public function action_custom_filters(){
        try{
            ...
            if(!empty($required_field) || !empty($lowerVal) || !empty($upperVal) || !empty($responsibility) || !empty($today) || !empty($closed_date_from) || !empty($closed_date_to)){
                $custom_filter_query = "SELECT * FROM opportunities LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c WHERE deleted != 1 AND ";
    ...
    public function action_filter_by_opportunity_status(){
        try
        {
            ...
            /*$fetch_query = " SELECT o.*, oc.* FROM opportunities AS o JOIN opportunities_cstm oc ON o.id = oc.id_c
                WHERE ( oc.user_id2_c = '$log_in_user_id' OR oc.delegate = '$log_in_user_id' ) AND o.deleted != 1 ";*/
            ...
            $fetch_query .= " WHERE ap.Approved = 0 AND ap.Rejected = 0 AND ap.pending = 1 AND o.deleted != 1 AND ( ap.approver_rejector = '$log_in_user_id' OR ap.delegate_id = '$log_in_user_id' ) AND ap.apply_for = '$status'";
            if($rowCount)
            ...
            if($_GET['filter'] && @$_GET['filter-closed-date-from'] && @$_GET['filter-closed-date-to']){
                $closedDateFrom = $_GET['filter-closed-date-from'];
                $closedDateTo = $_GET['filter-closed-date-to'];
                $fetch_query .= " AND DATE_FORMAT(o.date_closed, '%d/%m/%Y') BETWEEN '$closedDateFrom' AND '$closedDateTo' ";
            }
            if($_GET['filter'] && @$_GET['filter-created-date-from'] && @$_GET['filter-created-date-to']){
                $createdDateFrom = $_GET['filter-created-date-from'];
                $createdDateTo = $_GET['filter-created-date-to'];
    ...
    function getOpportunityStatusCount($status = null){
        ...
        $query = "SELECT count(*) as count FROM approval_table ap";
        $query .= " JOIN opportunities o ON o.id = ap.opp_id";
        $query .= " WHERE ap.Approved = 0 AND ap.Rejected = 0 AND ap.pending = 1 AND o.deleted != 1 AND ( ap.approver_rejector = '$log_in_user_id' OR ap.delegate_id = '$log_in_user_id' )";
    ...
    function delegateCountWithStatus($status, $userID){
        ...
        $query = "SELECT count(*) as count FROM approval_table ap";
        $query .= " JOIN opportunities o ON o.id = ap.opp_id";
        $query .= " WHERE ap.Approved = 0 AND ap.Rejected = 0 AND ap.pending = 1 AND o.deleted != 1 AND ap.approver_rejector = '$userID' AND ap.delegate_id = '$log_in_user_id' ";
    ...
    function getDelegateDetails(){
        ...
        $db = \DBManagerFactory::getInstance();
        $GLOBALS['db'];
        $query = "SELECT u.first_name, u.last_name, oc.user_id2_c FROM opportunities o JOIN opportunities_cstm oc ON oc.id_c = o.id JOIN users u ON u.id = oc.user_id2_c WHERE o.deleted != 1 AND oc.delegate = '$log_in_user_id' GROUP BY oc.user_id2_c ";
        $result = $GLOBALS['db']->query($query);
        $delegateData = array();
        while($row = $GLOBALS['db']->fetchByAssoc($result)){
            $dData = array(
    ...
    function getOpportunityStatusCountGraph($status = null){
        $db = \DBManagerFactory::getInstance();
        $GLOBALS['db'];
        if($status)
            $query = "SELECT count(*) as count FROM opportunities_cstm oc LEFT JOIN opportunities o ON o.id = oc.id_c WHERE oc.status_c = '".$status."' AND o.deleted != 1";
        else
            $query = "SELECT count(*) as count FROM opportunities_cstm oc LEFT JOIN opportunities o ON o.id = oc.id_c WHERE o.deleted != 1 AND oc.status_c != 'Lead' AND oc.status_c != 'Drop'";
    ...
    function action_get_approval_item(){
        try
        {
            ...
            $fetch_query = "SELECT o.*, oc.* FROM opportunities o JOIN approval_table ap ON ap.opp_id = o.id LEFT JOIN opportunities_cstm oc ON o.id = oc.id_c WHERE o.deleted != 1 AND ap.id = '$id'";
            $result = $GLOBALS['db']->query($fetch_query);
            while($row = $GLOBALS['db']->fetchByAssoc($result))
            {
    ...
    public function action_get_graph(){
        $totalCount = 0;
        $totalCount = $this->getOpportunityStatusCountGraph();
        // $leadCount = round($this->getOpportunityStatusCountGraph('Lead') / $totalCount * 100, 0);
        if ($totalCount > 0) {
            $QualifiedLeadCount = round($this->getOpportunityStatusCountGraph('QualifiedLead') / $totalCount * 100, 0);
            $QualifiedOpporunityCount = round($this->getOpportunityStatusCountGraph('Qualified') / $totalCount * 100, 0);
            $QualifiedDPR = round($this->getOpportunityStatusCountGraph('QualifiedDpr') / $totalCount * 100, 0);
            $QualifiedBid = round($this->getOpportunityStatusCountGraph('QualifiedBid') / $totalCount * 100, 0);
            $Close = round($this->getOpportunityStatusCountGraph('Closed') / $totalCount * 100, 0);
            $Drop = round($this->getOpportunityStatusCountGraph('Dropped') / $totalCount * 100, 0);
        }
        ...
        if($QualifiedLeadCount):
            $data .= '<div style="width: '.$QualifiedLeadCount.'%">
                    ...
                    <p style="text-align: center; margin-top: 5px;font-size: 11px;">'.$QualifiedLeadCount.'%</p>
                </div>';
        endif;
        ...
        if($QualifiedOpporunityCount):
            $data .= '<div style="width: '.$QualifiedOpporunityCount.'%">
                    ...
                    <p style="text-align: center; margin-top: 5px;font-size: 11px;">'.$QualifiedOpporunityCount.'%</p>
                </div>';
        endif;
        ...
        if($QualifiedDPR):
            $data .= '<div style="width: '.$QualifiedDPR.'%">
                    ...
                    <p style="text-align: center; margin-top: 5px;font-size: 11px;">'.$QualifiedDPR.'%</p>
                </div>';
        endif; 
        ...
        if($QualifiedBid):
            $data .= '<div style="width: '.$QualifiedBid.'%">
                    ...
                    <p style="text-align: center; margin-top: 5px;font-size: 11px;">'.$QualifiedBid.'%</p>
                </div>';
        endif;
        
        if($Close):
            $data .= '<div style="width: '.$Close.'%">
                    <div style="width: 100%; height: 70px; background-color: #FF7F00;"></div>
                    <p style="text-align: center; margin-top: 5px;font-size: 11px;">'.$Close.'%</p>
                </div>';
        endif; 
        ...
        if($Drop):
            $data .= '<div style="width: '.$Drop.'%">
                    ...
                    <p style="text-align: center; margin-top: 5px;font-size: 11px;">'.$Drop.'%</p>
                </div>';
        endif; 
    ...
    public function get_non_global_op_count() {
        global $current_user;
        $log_in_user_id = $current_user->id;
        $organiztion_non_global_count = "SELECT count(*) as org_non_global_count FROM opportunities WHERE opportunity_type = 'non_global' AND deleted != 1 AND 
            opportunities.id NOT IN(
            SELECT opp_id FROM untagged_user WHERE user_id LIKE '%$log_in_user_id%'
            )";
