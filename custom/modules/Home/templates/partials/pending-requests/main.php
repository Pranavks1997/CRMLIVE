<ul class="table-ul" style="display: flex; align-items: center;height: 50px;justify-content: space-between;">
    <div class="option_tabs_container">
        <li class="tableHeader-Content option_tab_header_btn" id="qualifylead" for="option_one">
            <div class="prt-top-headings" onClick="fetchByStatus('qualifylead', '', '', 1)">Qualify Lead (<?php echo @$qlLeadCount; ?>) </div>        </li>
        <li class="option_tab_header_btn" id="qualifyOpportunity" for="option_two">
            <div class="prt-top-headings" onClick="fetchByStatus('qualifyOpportunity', '', '', 1)">Qualify Opportunity (<?php echo @$qlOppCount; ?>) </div>
        </li>
        <li class="tableHeader-Content option_tab_header_btn" id="qualifyDpr" for="option_three">
            <div class="prt-top-headings" onClick="fetchByStatus('qualifyDpr', '', '', 1)">Qualify DPR (<?php echo @$qlDPRCount; ?>) </div>
        </li>
        <li class="tableHeader-Content option_tab_header_btn" id="qualifyBid" for="option_four">
            <div class="prt-top-headings" onClick="fetchByStatus('qualifyBid', '', '', 1)">Qualify Bid (<?php echo @$qlBidCount; ?>) </div>
        </li>
        <li class="tableHeader-Content option_tab_header_btn" id="closure" for="option_five">
            <div class="prt-top-headings" onClick="fetchByStatus('closure', '', '', 1)">Close (<?php echo @$qlClosedCount; ?>) </div>
        </li>

        <li class="tableHeader-Content option_tab_header_btn" id="Dropping" for="option_six">
            <div class="prt-top-headings" onClick="fetchByStatus('Dropping', '', '', 1)">Drop (<?php echo @$qlDroppedCount; ?>) </div>
        </li>
    </div>
    <div>
...
<table class="pending-request-table" 
    style="
