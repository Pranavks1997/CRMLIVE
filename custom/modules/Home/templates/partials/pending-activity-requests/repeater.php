        ...
        <tr>
            ...
            <td class="table-data">
                <div style="font-size: 20px;">
                    <i title="Approve" class="fa fa-check-circle" onClick="openActivityApprovalDialog('Approve','<?php echo $result['id']; ?>')"></i>
                    <i title="Reject" class="fa fa-times-circle" onClick="openActivityApprovalDialog('Reject','<?php echo $result['id']; ?>')"></i>
