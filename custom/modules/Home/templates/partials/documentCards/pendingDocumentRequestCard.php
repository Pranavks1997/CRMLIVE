<div style="display: flex;flex-direction: column;width: 220px;background-color: white;border-radius: 5px;padding: 10px;width: 170px;">
    ...
    <div style="display: flex;margin-top: 10px;justify-content: space-around;" class="pending-button-class">
        ...
        <button id="delegateBtn" onclick="fetchDelegateDialog()" style=" background-color: #242422; color: white; height: 30px; width: 90px; border-radius: 5px; padding: 5px; font-size: 14px; box-shadow: 0px 2px 2px rgba(0,0,0,0.4);">
            Delegate
        </button>
    </div>
</div>