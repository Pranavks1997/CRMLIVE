 ...
 */
    ...
    */
    ...
    function is_tagging_applicable($type, $id) {
        try {
            ...
            if($type == "opportunities") {
                ...
                if( $check_mc =="yes"||  $log_in_user_id == "1" || in_array($log_in_user_id, $team_func_array) || in_array($log_in_user_id, $tagged_user_array) ||  $this->is_creator($document_creator, $log_in_user_id) == true ){
                    return true;
                } else {
                    return false;
                }
    ...
    public function is_creator($creator_id, $logged_in_user_id) {
