...
//--------------------------------------sevrice dropdown--------------------------------------
 ...
 //--------------------------------------sevrice dropdown----------END----------------------------   
  ...
  $('#add_new_segment_c').replaceWith(`<input type="text" name="add_new_segment_c" id="add_new_segment_c" size="30" maxlength="70" value="" title=""><input type="button" class="btn button" id="first_kind_segment" value="Add Segment"/ >`);
    }else{
