...
class OpportunitiesViewList extends ViewList {
    ...
    function listViewProcess() {
      ...
      $sql='SELECT * FROM opportunities_users_2_c WHERE opportunities_users_2users_idb="'.$login_user_id.'" AND opportunities_users_2_c.deleted = 0';
