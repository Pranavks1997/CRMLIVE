...
$(document).ready(function () {
 ...
 //-------------------hiding navigation----
  ...
  $("[data-label=LBL_TAGGED_HIDEN],[data-label=LBL_UNTAGGED_HIDDEN],#tagged_hiden_c,#untagged_hidden_c").hide();
 ...
 if(opps_id ==""){
              ...
              $.ajax({
                ...
                if(data.mc=="yes") {
                 ...
                 $("#select_approver_c").val(data.fullname);
                 $("#user_id2_c").val(data.reporting_id);
                 $('#multiple_approver_c').val($('#user_id2_c').val());
              ...
              if(r=="no")  {
                ...
                if (s=="Qualified"||s=="QualifiedDpr"){
                   ...
                   if(data.user_id.length<=3){
                     ...
                     $("#select_approver_c").val(data.name);
                // $("#user_id2_c").val(data.reporting_id);
                $('#multiple_approver_c').val(data.user_id);
                  }
                  else{
                  
                          $("#select_approver_c").attr("disabled",false);
                    $('[field=select_approver_c]').html('<div class="demo"><select id="select_approver_c"  name="" multiple ></select></div>');
                      ...
                      if(data.status == true){
                        ...
                        $('.demo').dropdown({});
                         $(".dropdown-main  li:first-child").attr("disabled", true);
                      }
                     }
...
//                             &quot;single&quot;, 
//                             true
//                             );"><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_account_name" id="btn_clr_account_name" tabindex="0" title="Clear Account" class="button lastChild" onclick="SUGAR.clearRelateField(this.form, 'account_name', 'account_id');" value="Clear Account" style="display: none;"><span class="suitepicon suitepicon-action-clear"></span></button>
//                             </span>
//                             <script type="text/javascript">
//                             SUGAR.util.doWhen(
//                             		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['EditView_account_name']) != 'undefined'",
//                             		enableQS
//                             );
//                             </script>`;
//   //-------------------------------on load-------------------------------------------
...
//   $("[data-label=LBL_ACCOUNT_NAME],#btn_account_name,#account_name").hide();
//  $('#account_id,#account_name').val('');
//  $("[data-label=LBL_ACCOUNT_NAME] span").empty();
 
//   $('[data-label=LBL_NEW_DEPARTMENT]').show();
//  $('#new_department_c').show();
...
//               }
 ...
 $('#country_c').hide();
//  $('[data-label=LBL_NEW_DEPARTMENT]').hide();
//  $('#new_department_c').hide(); 
//   $("[data-label=LBL_COUNTRY] span").empty();
  
//   $('[data-label=LBL_ACCOUNT_NAME],#btn_account_name,#account_name').show();
   
//   if ($("[data-label=LBL_ACCOUNT_NAME] span").text() == "") {
               
//              $("[data-label=LBL_ACCOUNT_NAME]").append(
//               "<span style='color:red;'>*</span>"
//               );
//               }
   $('#state_c').show();
...
//               $('div[field="account_name"]').html(text11);
// }
   if(new_kind =='yes'){
...
// $("#non_financial_consideration_c").replaceWith('<html><body><div class="multiselect" id="non_financial_consideration_c"><label><input type="checkbox" name="option" class="Checkbox" id="no1"  value="NA" />NA</label><label><input type="checkbox" name="option" class="Checkbox" id="no2"  value="Pilot for Future Opportunity" />Pilot for Future Opportunity </label><label><input type="checkbox" name="option" class="Checkbox" id="no3"  value="New Service Line" />New Service Line</label><label><input type="checkbox" name="option" class="Checkbox" id="no4"  value="Brand Establishment" />Brand Establishment</label><label><input type="checkbox" name="option" class="Checkbox" id="no5"  value="Strategic Alignment For Future opportunity" />Strategic Alignment For Future opportunity</label><label><input type="checkbox" name="option" class="Checkbox" id="no6"  value="New Regional Development" />New Regional Development</label><label><input type="checkbox" name="option" class="Checkbox" id="no7"  value="Relationship" />Relationship</label></div><style>.multiselect { width: 23em;height: 10em;border:solid 1px #c0c0c0;overflow:auto;}.multiselect label {display:block;}.multiselect-on {color:#ffffff;background-color:#000099;}input[type=checkbox] {margin-left: 5px;}</style></body></html>');
...
// $('#non_financial_consideration_c').on("change",function(){
//     if($("#no1:checked")){
...
//     $("#no5").attr("disabled",false);
//     $("#no6").attr("disabled",false);
//     $("#no7").attr("disabled",false);
//     }
...
// // $("#non_financial_consideration_c").replaceWith(`<html><body><div class="multiselect"><div class="selectBox" ${onclick="showCheckboxes()"}><select><option>Select an option</option></select><div class="overSelect"></div></div><div id="checkboxes"><label for="one"><input type="checkbox" id="one" />First checkbox</label><label for="two"><input type="checkbox" id="two" />Second checkbox</label><label for="three"><input type="checkbox" id="three" />Third checkbox</label></div></div></body><style>.multiselect { width: 200px;}.selectBox {position: relative;}.selectBox select {width: 100%;font-weight: bold;}.overSelect {position: absolute;left: 0;right: 0;top: 0;bottom: 0;}#checkboxes {display: none;border: 1px #dadada solid;}#checkboxes label {display: block;}#checkboxes label:hover {background-color: #1e90ff;}</style></html>`);
