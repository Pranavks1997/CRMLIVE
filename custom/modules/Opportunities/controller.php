...
public function action_fetch_reporting_manager()
	...
	if(in_array($reporting,$report_mng)){
	    
	    			   if (($key = array_search($reporting, $report_mng)) !== false) {
	    			       
    unset($report_mng[$key]);
}
	    			}

	if(in_array($report_id,$report_mng)){
	    
	    			   if (($key = array_search($report_id, $report_mng)) !== false) {
