...
//--------------------------------------sevrice dropdown--------------------------------------
 ...
 //--------------------------------------sevrice dropdown----------END----------------------------   
  ...
  $('#add_new_segment_c').replaceWith(`<input type="text" name="add_new_segment_c" id="add_new_segment_c" size="30" maxlength="10" value="" title=""><input type="button" class="btn button" id="first_kind_segment" value="Add Segment"/ >`);
    }else{
    ...
    if($("#product_service_c").val()=='notAvailable'){
     ...
     if($("#product_service_c").val()=='notAvailable' && $("#segment_c").val()=='notAvailable'){
      ...
      $("option[value=notAvailable]").attr("disabled", true);
       ...
       $('#add_new_product_service_c').replaceWith(`<input type="text" name="add_new_product_service_c" id="add_new_product_service_c" size="30" maxlength="10" value="" title="" ><input type="button" class="btn button" id="first_kind_product1" value="Add Product"/ >`);
     }
