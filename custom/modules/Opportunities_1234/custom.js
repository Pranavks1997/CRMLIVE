...
$(document).ready(function () {
 ...
 $(".add_field_button").attr("class",'add_btn button');
 //-------------------hiding navigation----
  $(".opp_hide").hide();
...
if($("#opportunity_type").val()=="global"){
 ...
 if(opps_id !=""){
   ...
   $.ajax({
              ...
              if(r=="no"||r=="not_required")  {
               
                if (s=="Qualified"||s=="QualifiedDpr"||s=="QualifiedBid"||s=="Closed"||s=="Drop"||s=="Dropped"){
              ...
              if(r=="yes")  {
                ...
                if (s=="QualifiedLead"||s=="QualifiedBid"||s=="Closed"||s=="Drop"||s=="Dropped"){
...
//start1=start1+1;
                    ...
                    //alert(endy+"<br/>"+startq+"<br/>"+endq+"<br/>"+total );
