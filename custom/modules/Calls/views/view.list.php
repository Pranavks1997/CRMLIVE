...
class CallsViewList extends ViewList
{
    ...
    private function getTaggedActivities(){
    	global $current_user;
    ...
    private function getTLActivities(){
    	global $current_user;

    	$acc_ids = [];

    	// Get activities which are tagged to logged in user
    	$acc_ids = $this->getTaggedActivities();
		...
		$global_activities = $this->getGlobalActivities();
    ...
    private function getOtherActivities(){
    	global $current_user;
