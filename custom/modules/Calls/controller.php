...
class CallsController extends SugarController
{
    ...
    public function action_approve()
    {
        try
        {
            ...
            echo json_encode(['button' => 'hide', 'message' => 'Activity "' . $activity_name . '" approved successfully.']);
    ...
    public function action_reject()
    {
        try
        {
            ...
            echo json_encode(['button' => 'hide', 'message' => 'Activity "' . $activity_name . '" rejected successfully.']);
