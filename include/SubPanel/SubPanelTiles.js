...
function showSubPanel(child_field,url,force_load,layout_def_key){ $('#opportunities_documents_1_create_button').text('Upload');var inline=1;if(typeof(force_load)=='undefined'||force_load==null){force_load=false;}
